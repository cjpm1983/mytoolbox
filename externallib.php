...
class report_vivo_external extends external_api
{
    ...
    public static function get_user_from_cfield($customfield_name, $customfield_value)
    {
        ...
        $params = self::validate_parameters(
            self::get_user_from_cfield_parameters(),
            array('customfield_name' => $customfield_name, 'customfield_value' => $customfield_value)
        );
    ...
    public static function get_courses_by_teacher_id($teacher_id)
    {
        ...
        $params = self::validate_parameters(
            self::get_courses_by_teacher_id_parameters(),
    ...
    private function getFacultad($cid, $ccat)
    {
        ...
        //$parentcatids has the ids,  now we get the aditional field name of the parent category
    ...
    public static function get_courses_orphans($orphan)
    {
        ...
        $params = self::validate_parameters(
            self::get_courses_orphans_parameters(),
            array('orphan' => $orphan)
        );
